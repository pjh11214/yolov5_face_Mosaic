...
def export_tflite(
    ...
    Example:
        ...
        # Export the model
        export_tflite(keras_model, im, Path('model.tflite'), int8=True, per_tensor=False, data='data/face_msk.yaml',
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "/home/pengjiahao/yolov5-master/data/face_msk.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "/home/pengjiahao/yolov5-master/runs/train/exp/weights/best.pt", help="model.pt path(s)")
