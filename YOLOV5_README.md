...
```bash
python train.py --data face_msk.yaml --epochs 300 --weights '' --cfg yolov5n.yaml  --batch-size 128
                                                                 yolov5s                    64
                                                                 yolov5m                    40
                                                                 yolov5l                    24
                                                                 yolov5x                    16
...
python segment/val.py --weights yolov5s-seg.pt --data face_msk.yaml --img 640  # validate
```
